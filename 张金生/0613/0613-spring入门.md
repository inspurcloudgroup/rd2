...
![web应用程序应用场景](https://doc.shiyanlou.com/md0417212overview-full.png/wm)

- 远程访问应用场景：

![远程访问应用场景](https://doc.shiyanlou.com/md0417212overview-remoting.png/wm)

- EJB 应用场景：
![EJB应用场景](https://doc.shiyanlou.com/md0417212overview-ejb.png/wm)
