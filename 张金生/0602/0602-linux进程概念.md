...
![](https://dn-simplecloud.shiyanlou.com/1135081469027998669-wm)
...
pstree
```
![](https://dn-simplecloud.shiyanlou.com/1135081468836854017-wm)

或者从此图我们可以更加形象的看清子父进程的关系

![](https://dn-simplecloud.shiyanlou.com/1135081469030455439-wm)
...
```
![](https://dn-simplecloud.shiyanlou.com/1135081469004994601-wm)
...
ls &
```
![](https://dn-simplecloud.shiyanlou.com/1135081469036077882-wm)

图中所显示的 [1] 236分别是该 job 的 job number 与该进程的 PID，而最后一行的 Done 表示该命令已经在后台执行完毕。

我们还可以通过 ctrl + z 使我们的当前工作停止并丢到后台中去

![](https://dn-simplecloud.shiyanlou.com/1135081469036715105-wm)
...
![](https://dn-simplecloud.shiyanlou.com/1135081469037134869-wm)
...
![](https://dn-simplecloud.shiyanlou.com/1135081469037555070-wm)

![](https://dn-simplecloud.shiyanlou.com/1135081469037666320-wm)
...
bg [%jobnumber]
```
![](https://dn-simplecloud.shiyanlou.com/1135081469037983282-wm)
...
![](https://dn-simplecloud.shiyanlou.com/1135081469038840624-wm)
